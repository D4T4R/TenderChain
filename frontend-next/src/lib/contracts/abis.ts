...
export const TenderRepoABI = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum TenderRepo.TenderStatus",
        "name": "status",
        "type": "uint8"
      }
    ],
...
export const ContractRepoABI = [
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "enum ContractRepo.ContractStatus",
        "name": "",
        "type": "uint8"
      }
    ],
...
export const ContractorRepoABI = [
  {
    "inputs": [
      {
        "internalType": "address",
...
export const GovernmentOfficerRepoABI = [
  {
    "inputs": [
      {
        "internalType": "address",
...
export const FactoryContractorABI = [
  {
    "inputs": [
      {
        "internalType": "uint256",
...
export const FactoryGovernmentOfficerABI = [
  {
    "inputs": [
      {
        "internalType": "address",
...
export const FactoryVerifierABI = [
  {
    "inputs": [
      {
        "internalType": "uint256",
...
export const TenderABI = [
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "enum Tender.ProposalStatus",
        "name": "status",
        "type": "uint8"
      },
      {
...
export const ContractABI = [
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "enum Contract.TaskStatus",
        "name": "status",
        "type": "uint8"
      },
      {
  ...
  },
  {
    ...
    "name": "getMilestoneVerifications",
    "outputs": [
      {
        "components": [
          {
        ...
        "internalType": "struct Contract.MilestoneVerification[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
...
export const GovernmentOfficerABI = [
  {
    "inputs": [
      {
        "internalType": "address",
    ...
    "outputs": [
      {
        ...
        "internalType": "struct StakeManager.Stake[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
...
export const PublicClaimsABI = [
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "enum PublicClaims.ClaimStatus",
        "name": "status",
        "type": "uint8"
      },
      {
...
export const PublicDashboardABI = [
  {
    "inputs": [
      {
        "internalType": "address",
        "name": "_publicClaimsAddress",
        "type": "address"
      }
    ],
    "stateMutability": "nonpayable",
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum PublicDashboard.ContractStatus",
        "name": "newStatus",
        "type": "uint8"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract PublicClaims",
        "name": "",
        "type": "address"
      }
    ],
  ...
  },
  {
    ...
    "name": "getContractMilestoneProgress",
    "outputs": [
      {
        "internalType": "uint256[]",
        "name": "taskIndices",
  ...
  {
    "inputs": [],
    "name": "getCompletedContractsCount",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
...
export const ABIS = {
  TenderRepo: TenderRepoABI,
  ContractRepo: ContractRepoABI,
  ContractorRepo: ContractorRepoABI,
  GovernmentOfficerRepo: GovernmentOfficerRepoABI,
  FactoryTender: FactoryTenderABI,
  FactoryContract: FactoryContractABI,
  FactoryContractor: FactoryContractorABI,
  FactoryGovernmentOfficer: FactoryGovernmentOfficerABI,
  FactoryVerifier: FactoryVerifierABI,
  Tender: TenderABI,
  Contract: ContractABI,
  Contractor: ContractorABI,
  GovernmentOfficer: GovernmentOfficerABI,
  Verifier: VerifierABI,
  StakeManager: StakeManagerABI,
  PublicClaims: PublicClaimsABI,
  PublicDashboard: PublicDashboardABI,
} as const;
